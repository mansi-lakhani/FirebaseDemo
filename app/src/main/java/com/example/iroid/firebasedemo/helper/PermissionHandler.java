package com.example.iroid.firebasedemo.helper;
...
public class PermissionHandler extends Fragment {
    ...
    public static class Builder {
        ...
        public Builder setAllPermission(String[] permission) {
            this.permission = permission;
            return this;
        }

        public Builder setPermissionCallback(PermissionInterface permissionInterface) {
